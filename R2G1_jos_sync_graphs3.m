...
% % find the end number
% SNR_nonchron(i_sub,i_type, i_cond,i_perm, i_trials, i_wt)
% SNR_nc_end(i_sub,i_type, i_cond, i_wt) = 


%% Figure 5 (version 2): SNR comparison graph (NONCHRON)
% WALKCONDS = {'standing', 'walkingA', 'walkingT'};
% ETYPE = {'Active', 'Passive'};
mymap = [ 0.1328    0.5430    0.1328;  0.5977    0.1953    0.7969];
f8  = figure('Renderer', 'painters', 'Position', [10 10 800 600]);
...
%%  Combined chron + nonchron graphs
